...
**It's a marathon**. PhD is around 1000 days of work. Remember to plan your research long-term. 

**Do your homework**. Follow good ML principles and keep the quality bar high. Don't make shortcuts. Understand your own code and data and competing methods throughout. Prepare for any question a collegue could have. Don't submit unfinished manuscripts: I will reject papers with typos, poor formatting, poor figures, messy presentation, or sloppy math.

**Keep learning**. You need to become world’s top expert in your phd topic during it. This means reading 100's of papers during your phd. Most scientists know one thing very well, and apply it everywhere. For instance, differential geometry, Bayes, numerics, etc. This makes publishing papers much easier. 
...
**Make first-author papers**. To have a PhD and a career afterwards, you need to focus on making first-author papers where you were the driving force. If your paper record is mostly middle-author papers people can interpret this as poor priorities or inability to deliver.
...
**Make papers reader-friendly.** Write in a way that is accessible to a non-expert reader. Be explicit and precise. Use illustrations, colors and short paragraphs. Shorten as much as you can. Ask LLMs to improve the language. Write simple papers. If you can't, the idea is not yet ready from the oven. Organise internal peer-review with non-experts in your lab.
...
**The ideal story**. Science builds incrementally on top of earlier results. The earlier state-of-the-art is the bedrock, and your contribution sits on top. The steps are
